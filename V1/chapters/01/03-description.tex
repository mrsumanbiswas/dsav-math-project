...
\begin{minipage}{0.45\textwidth}
    ...
    \begin{tikzpicture}
        ...
        \draw[domain=0:4,smooth,variable=\x,blue] plot ({\x},{\f(\x)});
        
        % Fill the area under the curve
        \fill[gray!30,domain=1:3,variable=\x] (1,0) -- plot ({\x},{\f(\x)}) -- (3,0) -- cycle;
        
        % Mark the integral limits
        \draw[dashed] (1,0) node[below] {$a$} -- (1,{\f(1)});
        \draw[dashed] (3,0) node[below] {$b$} -- (3,{\f(3)});
        
        % Label the integral
        \node[above right] at (2,2) {$\int_{a}^{b} f(x) \, dx$};
      \end{tikzpicture}
...
\begin{minipage}{0.45\textwidth}
    ...
    \begin{tikzpicture}
        ...
        % Draw the function curve
        \draw[domain=0:4,smooth,variable=\x,red] plot ({\x},{\f(\x)});
        ...
        % Label the integral
        \node[below right] at (2,-1.5) {$\int_{a}^{b} (-f(x)) \, dx$};
      \end{tikzpicture}
    \captionof{figure}{Graph of $\int_{0}^{2} x \, dx$}
...
\begin{minipage}{0.45\textwidth}
    ...
    \begin{tikzpicture}
        \begin{axis}[
            ...
            domain=-2*pi:2*pi,
            samples=100,
            % You can customize the appearance of the plot
            % For example:
            % color=blue,
            % thick,
            % mark=none,
        ...
        % Add the shaded area under the curve
        \addplot[blue, fill=blue!30, domain=-pi/2:pi/2] {sin(deg(x))} \closedcycle;
